...
namespace projectEDPforreal
{
    public partial class Login : Form
    {
      ...
      AttachDbFilename=C:\Users\User\OneDrive\Documents\GitHub\edp_concertTicketingSystem\projectEDPforreal\Ticket2U.mdf;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(
                    @"Data Source=(LocalDB)\MSSQLLocalDB;
              AttachDbFilenameC:\Users\User\OneDrive\Documents\GitHub\edp_concertTicketingSystem\projectEDPforreal\Ticket2U.mdf;
              Integrated Security=True"))
                {
                    con.Open();
